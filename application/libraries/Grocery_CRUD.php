...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_language_path				= 'static/grocery_crud/languages';
	protected $default_config_path					= 'static/grocery_crud/config';
	protected $default_assets_path					= 'static/grocery_crud';
